...
const Table = ({ title = "Ablities", items, openForm }) => {
  const [isUserModalOpen, setIsUserModalOpen] = useState(false);
  const [editId, setEditId] = useState();
  // get the data from Ability reducer and put it in use callback

  const openUserModal = (i) => {
    const ClickedButtonIndex = i.target.id;
    setEditId([ClickedButtonIndex, items[ClickedButtonIndex]?.id || items[ClickedButtonIndex]?._id]);
