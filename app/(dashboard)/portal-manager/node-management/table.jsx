...
const Table = ({ title = "All Nodes", items, openForm }) => {
  ...
  const openUserModal = (i) => {
    const ClickedButtonIndex = i.target.id;
    // console.log("targetID:", i.target.id)
    SetEditId([ClickedButtonIndex, items[ClickedButtonIndex]._id]);
  ...
  const COLUMNS = [
    ...
    {
      Header: "eNode Address",
      accessor: "eNodeAddress",
      Cell: (row) => {
        return <span>{row?.cell?.value}</span>;
      },
    },
    ...
    {
        Header: "staticIpAddress",
        accessor: "staticIpAddress",
        Cell: (row) => {
        return <span >{row?.cell?.value}</span>;
        },
    },
      ...
      Cell: (row) => {
        return (
          <span className="block w-full">
            ...
            >
              {row?.cell?.value == true ?  "Active" : "inActive"}
            </span>
          </span>
        );
      },
