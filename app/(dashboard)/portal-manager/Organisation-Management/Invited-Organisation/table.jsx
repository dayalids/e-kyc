...
const Table = ({ title = 'All Invited Organisation', items }) => {
  ...
  const onSubmit = async () => {
    // console.log('Selected Items with id', selectedRowIds);
    if (selectedRowIds.length == 0) {
      ...
      try {
        ...
        // console.log('invited again', mutationData);
        if (error) {
        ...
        clearSelectedRow(); //setting row selecton empty
      } catch (error) {
        ...
        return (
          <span className="block w-full">
            <span
              ...
              `}
            >
              {row?.cell?.value === 1 ? 'Invited' : 'Registered'}
            </span>
          </span>
        );
      },
      ...
      <Card>
        <div className="md:flex justify-between items-center mb-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            ...
            <Button
              text="Resend Invite"
              className="btn btn-dark text-white py-2"
              onClick={() => {
                onSubmit();
              }}
            />
