...
const schema = yup
  ...
  const MouPage = ({ userData,Data }) => {
    ...
    const assigneeOptions = [  
      ...
      { value: '1', label: 'Under Progress', color: 'purple' },
      { value: '2', label: 'In Review', color: 'blue' },
  ...
  const status = 3 //remove this and add userData?.status once api ready
              ...
              <div className="w-full ">
                <div  >
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: assigneeOptions.find((option) => option.value == 3)?.color,//remove hardcode values to userData?.status once api ready
                      color: 'white',  
                    }}
                  >
