...
const StudentAmbassador = ({ entityData }) => {
  const [tableData, setTableData] = useState([]);

  const studentAmbassadorWithIndex = entityData?.studentAmbassador.map(
    (item, index) => ({
      ...item,
      id: index + 1,
    })
  ...
  useEffect(() => {
    setTableData(studentAmbassadorWithIndex);
  }, [studentAmbassadorWithIndex]);
