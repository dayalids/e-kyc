...
import { ADD_GLOBAL_USER } from "@/configs/graphql/mutations";
...
const Add = ({ isModalOpen, setIsModalOpen }) => {
  const [addglobaluser] = useMutation(ADD_GLOBAL_USER);
  ...
  const onSubmit = async (data) => {
    ...
    const { inputValues: apiData, error } = await addglobaluser({
      variables: {
        input: {
